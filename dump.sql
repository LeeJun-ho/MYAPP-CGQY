...
CREATE TABLE `orders` (
  ...
  `code` char(12) CHARACTER SET utf8 NOT NULL COMMENT '주문번호',
  `user_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `users` (
  ...
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '패스워드',
...
-- Dump completed on 2023-02-28 21:58:13
